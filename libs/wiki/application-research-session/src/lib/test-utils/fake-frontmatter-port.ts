/**
 * Shared in-memory FakeFrontmatterPort test double for application-research-session specs.
 *
 ...
 * for the author/publication-source page append paths exercised in finalize-step tests.
 */
