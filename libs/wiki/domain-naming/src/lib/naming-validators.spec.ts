...
describe('isValidDateFormat', () => {
  ...
  it('should reject invalid date formats', () => {
    expect(isValidDateFormat('2024-5-10')).toBe(false);
    expect(isValidDateFormat('24-05-10')).toBe(false);
    expect(isValidDateFormat('05-10-2024')).toBe(false);
    expect(isValidDateFormat('2024/05/10')).toBe(false);
  });
...
describe('validateWikiPageName', () => {
  ...
  it('should throw error for invalid page type', () => {
    expect(() => {
      validateWikiPageName('test.md', 'invalid' as 'entity' | 'concept' | 'source');
