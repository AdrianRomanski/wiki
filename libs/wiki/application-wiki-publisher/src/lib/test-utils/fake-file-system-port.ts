/**
 * Shared in-memory FakeFileSystemPort test double for application-wiki-publisher specs.
 *
 ...
 *   (used for entity/concept/source page publication tests)
 *
...
export class FakeFileSystemPort implements FileSystemPort {
  ...
  // ── Raw-scoped file I/O (unused by wiki-publisher use cases) ───────────────
  ...
  /** Removes all wiki-relative files (test setup helper, mirrors real-fs rmSync of wiki/). */
  clearWikiFiles(): void {
    this.wikiFiles.clear();
  }
